...
@section('title', 'Halaman Data Pengunjung')
...
<div class="page-heading">
    ...
    <section class="section">
      <div class="card">
        ...
        <div class="card-header">Tabel Pengunjung</div>
        <div class="card-body">
                ...
                <tbody>
                 ...
                 <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('admin.pengunjung.delete', $item->id) }}"
        ...
        <form action="{{ route('admin.pengunjung.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel1">Form Tambah Data Pengunjung</h5>
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" value="{{ old('no_hp') }}" name="no_hp" placeholder="Masukan Nomor Handphone" required>
                        </div>
...
<div class="modal-dialog modal-dialog-scrollable" role="document">
      <form action="#" id="form-edit" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="myModalLabel1">Form Edit Data Pengunjung</h5>
                  <button type="button" class="close rounded-pill" data-bs-dismiss="modal"
                      aria-label="Close">
                      <i data-feather="x"></i>
                  </button>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                          <label for="helpInputTop">Nomor Handphone</label>
                          <input type="number" class="form-control" id="no_hp" value="{{ old('no_hp') }}" name="no_hp" placeholder="Masukan Nomor Handphone" required>
                      </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#edit', function() {
                ...
                $('#name').val(name);
                $('#no_hp').val(no_hp);
                $('#form-edit').attr('action','/admin/pengunjung/update/' + id);
            });
        });
    </script>
  @endpush
